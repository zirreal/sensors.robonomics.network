export default {
  ...
  "\"What is outside the window right now?\"": "«Что за окном прямо сейчас?»",
  "Insight (bedroom / living room)": "Insight (спальня / гостиная)",
  "CO2": "CO2",
  "Temperature": "Температура",
  "Humidity": "Влажность",
  "E-ink display 4.2\" + SD card": "E-ink дисплей 4.2\" + SD-карта",
  "\"What am I breathing at home?\"": "«Чем я дышу дома?»",
  ...
  "Quick environment assessment when moving — data you'll discover over years. Charts boost the appeal of rental housing.": "Быстрая оценка среды при переезде — данные, которые узнаёшь за годы. Графики повышают привлекательность арендного жилья.",
  ...
  "Go to «GPS & Sensors» and enter the GPS coordinates of your sensor's location.": "Перейдите в «GPS & Sensors» и введите GPS-координаты места установки датчика.",
  "Use": "Используйте",
  ...
  "Saying \"the construction is loud\" is an opinion. Showing a month-long noise graph with daily peaks above 90 dB is evidence. We believe real sensor data fundamentally changes the context of housing negotiations — whether you are renting or buying.": "«Стройка шумит» — это мнение. График шума за месяц с ежедневными пиками выше 90 дБ — это доказательство. Мы считаем, что реальные данные с датчиков принципиально меняют контекст переговоров по жилью — будь то аренда или покупка.",
  "The Hypothesis": "Гипотеза",
  "Imagine you have a noise sensor on your balcony. Over a month, it builds a complete noise pollution profile — 24/7, day and night. When it's time to renegotiate your lease, you come to the table not with feelings, but with data.": "Представьте, что у вас на балконе стоит датчик шума. За месяц он формирует полный профиль шумового загрязнения — 24/7, днём и ночью. Когда приходит время пересмотреть условия аренды, вы приходите на встречу не с эмоциями, а с данными.",
  "Your landlord sees daily graphs with red and orange spikes. They can choose to ignore it — but it's much harder to dismiss a chart with clear explanations of how harmful these levels are, especially when the data is publicly available on an environmental monitoring map.": "Арендодатель видит ежедневные графики с красными и оранжевыми пиками. Можно проигнорировать — но сложнее отмахнуться от графика с пояснением, насколько это вредно, особенно когда данные доступны публично на карте мониторинга окружающей среды.",
  "And here's the real leverage: if the landlord doesn't make concessions, how easy will it be to re-rent a place when prospective tenants can see the noise profile themselves?": "А вот и главный рычаг: если арендодатель не пойдёт на уступки, насколько легко будет пересдать жильё, когда потенциальные арендаторы сами увидят профиль шума?",
  ...
  "Noise data isn't just about complaints. If your balcony sensor shows six months or a year of consistently low noise, that's a selling point. Your apartment rents faster and at a higher price.": "Данные о шуме — это не только про жалобы. Если датчик на балконе показывает полгода или год стабильно низкого шума — это аргумент для продажи. Квартира сдаётся быстрее и дороже.",
