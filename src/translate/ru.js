export default {
  ...
  "Announcement on the website + resident meetings: \"10–20 sensors funded for homes around these construction sites.\"": "Объявление на сайте + собрание жителей: «Оплачены 10–20 датчиков для домов вокруг таких-то строек».",
  ...
  "The municipality keeps a stock of sensors and distributes on request, knowing the citizen's address — this ensures coverage precisely around the construction site.": "Муниципалитет хранит запас датчиков и выдаёт по запросу, зная адрес гражданина — так формируется покрытие именно вокруг стройки.",
  "Result:": "Результат:",
  ...
  "Supplier and Next Step": "Поставщик и следующий шаг",
  "Pinout Ltd": "Pinout Ltd",
  "Cyprus": "Кипр",
  "supplier of sensors, visualization platform, and installation service.": "поставщик датчиков, платформы визуализации и сервиса установки.",
  "The company founders are the authors of the open-source sensor project and the sensors.social platform.": "Основатели компании — авторы open-source проекта датчика и платформы sensors.social.",
  "Next step:": "Следующий шаг:",
  "pilot project at 1 construction site.": "пилотный проект на 1 строительной площадке.",
  "6–10 sensors, municipal dashboard.": "6–10 датчиков, муниципальный dashboard.",
  "3–6 months of data collection and threshold calibration.": "3–6 месяцев сбора данных и калибровки порогов.",
  "Results evaluation and scaling decision.": "Оценка результатов и принятие решения о масштабировании.",
  "Contact:": "Контакт:",
};
