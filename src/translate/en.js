export default {
  ...
  "Announcement on the website + resident meetings: \"10–20 sensors funded for homes around these construction sites.\"": "Announcement on the website + resident meetings: \"10–20 sensors funded for homes around these construction sites.\"",
  ...
  "The municipality keeps a stock of sensors and distributes on request, knowing the citizen's address — this ensures coverage precisely around the construction site.": "The municipality keeps a stock of sensors and distributes on request, knowing the citizen's address — this ensures coverage precisely around the construction site.",
  "Result:": "Result:",
  ...
  "Supplier and Next Step": "Supplier and Next Step",
  "Pinout Ltd": "Pinout Ltd",
  "Cyprus": "Cyprus",
  "supplier of sensors, visualization platform, and installation service.": "supplier of sensors, visualization platform, and installation service.",
  "The company founders are the authors of the open-source sensor project and the sensors.social platform.": "The company founders are the authors of the open-source sensor project and the sensors.social platform.",
  "Next step:": "Next step:",
  "pilot project at 1 construction site.": "pilot project at 1 construction site.",
  "6–10 sensors, municipal dashboard.": "6–10 sensors, municipal dashboard.",
  "3–6 months of data collection and threshold calibration.": "3–6 months of data collection and threshold calibration.",
  "Results evaluation and scaling decision.": "Results evaluation and scaling decision.",
  "Contact:": "Contact:",
  ...
  "\"What is outside the window right now?\"": "\"What is outside the window right now?\"",
  "Insight (bedroom / living room)": "Insight (bedroom / living room)",
  "CO2": "CO2",
  "Temperature": "Temperature",
  "Humidity": "Humidity",
  "E-ink display 4.2\" + SD card": "E-ink display 4.2\" + SD card",
  "\"What am I breathing at home?\"": "\"What am I breathing at home?\"",
  ...
  "Quick environment assessment when moving — data you'll discover over years. Charts boost the appeal of rental housing.": "Quick environment assessment when moving — data you'll discover over years. Charts boost the appeal of rental housing.",
  ...
  "Go to «GPS & Sensors» and enter the GPS coordinates of your sensor's location.": "Go to «GPS & Sensors» and enter the GPS coordinates of your sensor's location.",
  "Use": "Use",
  ...
  "Saying \"the construction is loud\" is an opinion. Showing a month-long noise graph with daily peaks above 90 dB is evidence. We believe real sensor data fundamentally changes the context of housing negotiations — whether you are renting or buying.": "Saying \"the construction is loud\" is an opinion. Showing a month-long noise graph with daily peaks above 90 dB is evidence. We believe real sensor data fundamentally changes the context of housing negotiations — whether you are renting or buying.",
  "The Hypothesis": "The Hypothesis",
  "Imagine you have a noise sensor on your balcony. Over a month, it builds a complete noise pollution profile — 24/7, day and night. When it's time to renegotiate your lease, you come to the table not with feelings, but with data.": "Imagine you have a noise sensor on your balcony. Over a month, it builds a complete noise pollution profile — 24/7, day and night. When it's time to renegotiate your lease, you come to the table not with feelings, but with data.",
  "Your landlord sees daily graphs with red and orange spikes. They can choose to ignore it — but it's much harder to dismiss a chart with clear explanations of how harmful these levels are, especially when the data is publicly available on an environmental monitoring map.": "Your landlord sees daily graphs with red and orange spikes. They can choose to ignore it — but it's much harder to dismiss a chart with clear explanations of how harmful these levels are, especially when the data is publicly available on an environmental monitoring map.",
  "And here's the real leverage: if the landlord doesn't make concessions, how easy will it be to re-rent a place when prospective tenants can see the noise profile themselves?": "And here's the real leverage: if the landlord doesn't make concessions, how easy will it be to re-rent a place when prospective tenants can see the noise profile themselves?",
  ...
  "Noise data isn't just about complaints. If your balcony sensor shows six months or a year of consistently low noise, that's a selling point. Your apartment rents faster and at a higher price.": "Noise data isn't just about complaints. If your balcony sensor shows six months or a year of consistently low noise, that's a selling point. Your apartment rents faster and at a higher price.",
